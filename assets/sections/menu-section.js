...
export class Menu extends LitElement {
  ...
  render() {
    return html` <dialog>
      <nav>
        <button @click=${this.rolarContatos}>
          Contato <feather-icon icon="phone"></feather-icon>
        </button>
        <button @click=${this.rolarServicos}>
          Serviços <feather-icon icon="truck"></feather-icon>
        </button>
        <button @click=${this.rolarSobreNos}>
          Sobre nós <feather-icon icon="users"></feather-icon>
        </button>
